...
Um objeto [EntityWrapper](../entity-wrapper/entity-wrapper.md) possui o método *findGenericValue* que recebe o código de um campo do formulário como parâmetro e retorna o valor armazenado nesse campo. 
Assinatura do método é:

![Assinatura do método findGenericValue()](./imgs/method-signature.png "Assinatura do método findGenericValue()")

*Assinatura do método findGenericValue().*

perceba que o findGenericValue:

- Recebe uma string como parâmetro, que é o **código** de um campo (o código do campo, não o nome!).
...
![Trazendo valor para o código](./imgs/print-valor.png "Trazendo valor para o código")

*Trazendo valor para o código.*

Executando o processo:

![Funcionário preenche dados](./imgs/process1.png "Funcionário preenche dados")
...
![Fluxo do processo](./imgs/process-workflow1.png "Fluxo do processo")

*Fluxo do processo.*

Após enviar: 

![Print do valor no console](./imgs/printed-value.png "Print do valor no console")
...
!!! warning
    Utilize os tipos com letras maiúsculas no Java.  Por exemplo, não utilize long e sim Long. A diferença é que com maiúsculo é um objeto e não um tipo primitivo, e portanto, permite valores nulos. 
